namespace Ma2013.A.E.O.Classes.Contexts.TP
{
    ...
    internal sealed class TPOutputContext : ITPOutputContext
    {
        ...
        public ImmutableList<Tuple<FhirDateTime, INullableValue<decimal>>> DayBedRequirementMeans { get; }

        public ImmutableList<Tuple<FhirDateTime, INullableValue<decimal>>> DayBedRequirementVariances { get; }
        ...
        public ImmutableList<Tuple<Organization, INullableValue<int>>> SurgeonGroupNumberPatients { get; }
        ...
        public ImmutableList<Tuple<Organization, INullableValue<int>>> WardNumberAssignedOperatingRooms { get; }

        public ImmutableList<Tuple<Organization, INullableValue<int>>> WardNumberAssignedActiveDays { get; }
